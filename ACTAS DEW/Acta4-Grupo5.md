## Reunión 4 - Script de Datos, Documentación y Preparación del Hito 1
...
* Intento de creación script de shell para poblar `CentroEducativo` usando `curl` pero sin éxito total.
* Completar funcionamiento del filtro Logs.
